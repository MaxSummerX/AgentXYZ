...
def build_assistant_message(
    ...
    """Создаёт совместимое с провайдером сообщение ассистента с опциональными полями рассуждения."""
...
def estimate_prompt_tokens(
    ...
    """Оценивает количество токенов в промпте с помощью tiktoken."""
    try:
...
def estimate_message_tokens(message: dict[str, Any]) -> int:
    """Оценивает количество токенов, вносимых одним сохранённым сообщением."""
...
def estimate_prompt_tokens_chain(
    ...
    """Оценивает токены промпта через счётчик провайдера, затем tiktoken как запасной вариант."""
