"""Инструмент message для отправки сообщений пользователям."""
...
class MessageTool(Tool):
    """Инструмент для отправки сообщений пользователям в чат-каналах."""
    ...
    def set_context(
        ...
        """Установить контекст текущего сообщения."""
    ...
    def start_turn(self) -> None:
        """Сбросить отслеживание отправки за раунд."""
    ...
    def parameters(self) -> dict[str, Any]:
        return {
            ...
            "properties": {
                ...
                "channel": {
                    "type": "string",
                    "description": "Optional: target channel (telegram, email, etc.)",
                },
                "chat_id": {
                    "type": "string",
