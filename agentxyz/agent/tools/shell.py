...
class ExecTool(Tool):
    ...
    def __init__(
        ...
        self.deny_patterns = deny_patterns or [
            ...
            r"(?:^|[;&|]\s*)format\b",  # format (только как отдельная команда)
        ...
        **kwargs: Any,
        ...
        try:
            ...
            try:
                ...
                process.kill()
                # Подождите полного завершения процесса, чтобы
                # каналы были считаны до конца, а файловые дескрипторы освобождены.
                try:
    ...
    def _guard_command(self, command: str, cwd: str) -> str | None:
        """Усердная защита от потенциально разрушительных команд."""
        cmd = command.strip()
        lower = cmd.lower()
        ...
        from agentxyz.security.network import contains_internal_url
